  ...
  <x-slot:pageTitle>
    ...
    <x-slot:headerFiles>
      ...
      <div class="seperator-header layout-top-spacing">
        <a type="button" class="btn btn-success" href="{{ route('tandaterima.create') }}">Tambah</a>
      </div>
      <div class="row">
        @empty(!$data)
                      ...
                      <tr>
                        ...
                        <td>
                          @foreach ($data->berkas as $berkas)
                            <ul>
                                <li>{{ $berkas['nama'] }} - Jumlah {{ $berkas['jumlah'] }}</li>
                            </ul>
                          @endforeach
                        </td>
                        <td>
                          @role('Master')
                            <div class="btn-group">
                              <a href="{{ route('tandaterima.print') }}?id={{ $data->id }}"
