    ...
    <x-slot:pageTitle>
        ...
        <x-slot:headerFiles>
            ...
            <div class="seperator-header layout-top-spacing">
                <h4 class="">Ubah Data Pelaksana</h4>
            </div>
            ...
            <div class="row">
                <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                    ...
                    <form class="simple-example needs-validation" method="post" action="{{ route('pelaksana.update', $pelaksana->id) }}"
                        novalidate>
                        @csrf
                        @method('PUT')
                        <div class="form-row">
                            ...
                            <div class="col-md-12 mb-4">
                                ...
                                <input type="text" class="form-control" id="alamat" name="alamat" placeholder="Alamat Pelaksana"
                                    value="{{ $pelaksana->alamat }}" required>
                            ...
                            <div class="col-md-12 mb-4">
                                ...
                                <input type="text" class="form-control" id="npwp" name="npwp"
                                    placeholder="NPWP Pelaksana" value="{{ $pelaksana->npwp }}" required>
                                <div class="invalid-feedback">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6 mb-4">
                                    ...
                                    <input type="text" class="form-control" id="direktur" name="direktur"
                                        placeholder="Nama Direktur" value="{{ $pelaksana->direktur }}" required>
                                    <div class="invalid-feedback">
                                    </div>
                                </div>
                                <div class="col-md-6 mb-4">
                                    ...
                                    <input type="text" class="form-control" id="kontak" name="kontak"
                                        placeholder="Nomor Kontak" value="{{ $pelaksana->kontak }}">
                                    <div class="invalid-feedback">
                                    </div>
                                </div>
                            </div>
