        ...
        <x-slot:headerFiles>
            ...
            <div class="row">
                <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                    ...
                    <form class="simple-example needs-validation" method="post" action="{{ route('kegiatan.store') }}"
                        novalidate>
                        @csrf
                        <div class="form-row">
                            <div class="col-md-12 mb-4">
                                <label for="program">Nama Program</label>
                                <input type="text" class="form-control" id="program" name="program" placeholder=""
                                    value="" required>
                            ...
                            <div class="col-md-12 mb-4">
                                ...
                                <input type="text" class="form-control" id="kegiatan" name="kegiatan" placeholder=""
                                    value="" required>
