    ...
    <x-slot:pageTitle>
      ...
      <x-slot:headerFiles>
        ...
        <div class="seperator-header layout-top-spacing">
          <a type="button" class="btn btn-success" href="{{ route('tugas.create') }}">Tambah</a>
        </div>
        <div class="row">
          @empty(!$data)
                  ...
                  <table id="html5-extension" class="dt-table-hover table" style="width:100%">
                    ...
                    <tbody>
                      ...
                      @foreach ($data as $data)
                        <tr>
                          <td>{{ $i++ }}</td>
                          <td>{{ $data->nomor }} - {{ $data->tanggal }}</td>
                          <td>
                            @foreach ($data->kepada as $kepada)
                              <ul>
                                  <li>{{ $kepada['nama'] }}</li>
                              </ul>
                            @endforeach
                          ...
                          <td>
                            @role('Master')
                              <div class="btn-group">
                                <a href="{{ route('tugas.print') }}?id={{ $data->id }}"
                                ...
                                {{-- <a href="{{ route('tandaterima.edit', $data->id) }}"
