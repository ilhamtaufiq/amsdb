                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form id="input" class="simple-example needs-validation" method="post"
                                ...
                                @method('PUT')
                                <div class="form-row">
                                    <div class="col-md-4 mb-4 switch form-switch-custom switch-inline form-switch-warning">
                                        <input type="hidden" name="pokir" value="0">
                                        <input class="switch-input" type="checkbox" value="1" name="pokir" role="switch" id="form-custom-switch-warning" {{ $pekerjaan->pokir == 1 ? 'checked':'' }}>
                                        <label class="switch-label" for="form-custom-switch-warning">Pokir</label>
                                    </div>
                                    <div class="col-md-12 mb-4">
                                        <label for="pekerjaan">Nama Paket Pekerjaan</label>
                                        <input value="{{ $pekerjaan->nama_pekerjaan }}" type="text"
                                            class="form-control" id="pekerjaan" name="nama_pekerjaan" placeholder=""
                                            value="" required>
                                    ...
                                    <div class="col-md-12 mb-4">
                                        ...
                                        <select class="form-control" name="keg_id" id="select-beast"
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 mb-4">
                                            ...
                                            <select class="form-control" name="kec_id" id="select-kec"
                                                placeholder="Pilih Kecamatan" autocomplete="off" required="">
                                        ...
                                        <div class="col-md-4 mb-4">
                                            ...
                                            <select class="form-control desa" name="desa_id" id="desa"
                                                class="form-control" placeholder="Pilih Desa" autocomplete="off"
                                                required="">
                                        ...
                                        <div class="col-md-4 mb-4">
                                            ...
                                            <input value={{ $pekerjaan->pagu }} type="number" class="ts-control"
                                                id="pagu" name="pagu" placeholder="" value="" required>
                                            <div class="invalid-feedback">
                                            </div>
                                        </div>
                                    </div>
