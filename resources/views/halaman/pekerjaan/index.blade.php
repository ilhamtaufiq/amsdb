    ...
    <x-slot:pageTitle>
        ...
        <x-slot:headerFiles>
            ...
            <div class="seperator-header layout-top-spacing">
                <a type="button" class="btn btn-success" href="{{ route('pekerjaan.create') }}">Tambah</a>
            </div>
            <div class="row">
                @empty(!$pekerjaan)
                                      ...
                                      <tr>
                                        ...
                                        <td>
                                          <div class="btn-group">
                                            ...
                                            <a href="{{ route('pekerjaan.edit', $pekerjaan->id) }}" class="action-btn btn-edit bs-tooltip me-2"
                                            ...
                                            <form action="{{ route('pekerjaan.destroy', $pekerjaan->id) }}" method="post">
                                              @csrf
                                              @method('delete')
                                              <a type="submit" class="action-btn btn-edit bs-tooltip me-2 hapus" class="action-btn btn-delete bs-tooltip"
