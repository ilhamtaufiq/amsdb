          ...
          <div class="card">
            <div class="card-body">
              ...
              <form id="input" class="simple-example needs-validation" method="post"
                    action="{{ route('nphd.store') }}" novalidate>
                @csrf
                <div class="form-row">
                  <div class="row">
                    ...
                    <div class="col-md-4 mb-4">
                      ...
                      <input type="text" class="ts-control" id="bangunan" name="bangunan"
                             placeholder="Nama Bangunan" value="" required>
                      <div class="invalid-feedback">
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-md-6 mb-4">
                      ...
                      <input type="text" class="ts-control" id="pengelola" name="pengelola"
                             placeholder="Nama Pengelola" value="" required>
                      <div class="invalid-feedback">
                      </div>
                    </div>
                    <div class="col-md-6 mb-4">
                      <label for="ketua">Ketua Pengelola</label>
                      <input type="text" class="ts-control" id="ketua" name="ketua"
                             placeholder="Nama Ketua Pengelola" value="" required>
                      <div class="invalid-feedback">
                      </div>
                    </div>
                  </div>
