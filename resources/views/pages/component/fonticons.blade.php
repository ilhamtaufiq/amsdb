<x-base-layout :scrollspy="true">
    ...
    <div id="navSection" data-bs-spy="affix" class="nav sidenav">
        <div class="sidenav-content">
            <a href="#fontIconFeather" class="active nav-link">Feather</a>
            <a href="#fontIconFontawesome" class="nav-link">Fontawesome</a>
        </div>
    </div>

    <div class="row layout-spacing layout-top-spacing feather-icon">
        <div id="fontIconFeather" class="col-lg-12">
...
&lt;/script&gt;</pre>
    ...
    <div class="row layout-spacing fontawesome">
        <div id="fontIconFontawesome" class="col-lg-12">
            <div class="statbox widget box box-shadow">
                <div class="widget-content widget-content-area bx-top-6">
                    <div class="icon-section">
