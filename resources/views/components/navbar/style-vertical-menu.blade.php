        ...
        <ul class="navbar-item flex-row ms-lg-auto ms-0">
            ...
            <li class="nav-item dropdown language-dropdown">
                <a href="javascript:void(0);" class="nav-link dropdown-toggle" id="language-dropdown"
                    ...
                    {{ app('request')->input('tahun_anggaran') ?? Carbon\Carbon::now()->format('Y') }}
                </a>
                <div class="dropdown-menu position-absolute" aria-labelledby="language-dropdown">
                    <a class="dropdown-item d-flex"
                        href="?tahun_anggaran={{ Carbon\Carbon::now()->format('Y') }}">{{ Carbon\Carbon::now()->format('Y') }}</a>
                    <a class="dropdown-item d-flex" href="?tahun_anggaran=2022">2022</a>
                    <a class="dropdown-item d-flex" href="?tahun_anggaran=2021">2021</a>
                </div>
            </li>
